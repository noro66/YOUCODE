...
<div class="h-screen my-auto flex flex-col items-center justify-center px-6  mx-auto bg-gray-900  lg:py-0">
    <div class="w-full bg-white rounded-lg shadow white:border md:mt-0 sm:max-w-md xl:p-0 white:bg-gray-800 white:border-gray-700">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8  bg-gray-900">
