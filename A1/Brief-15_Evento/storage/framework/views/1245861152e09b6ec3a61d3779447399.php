...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('organizer.register')); ?>">
        <?php echo csrf_field(); ?>
        <!-- Name -->
        <div>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="<?php echo e(route('organizer.forget_password')); ?>">
...
<?php endif; ?>
<?php /**PATH /var/www/html/YOUCODE/A1/Brief-15_Evento/resources/views/organizer/register.blade.php ENDPATH**/ ?>