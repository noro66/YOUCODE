...
<div class="h-screen my-auto flex flex-col items-center justify-center px-6  mx-auto  lg:py-0">
    <div class="w-full bg-white rounded-lg shadow white:border md:mt-0 sm:max-w-md xl:p-0 white:bg-gray-800 white:border-gray-700">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <?php endif; ?>
            <form class="space-y-4 md:space-y-6" method="post" action="<?php echo e(route('admin.reset_password_submit')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/YOUCODE/A1/Brief-15_Evento/resources/views/admin/reset-password.blade.php ENDPATH**/ ?>